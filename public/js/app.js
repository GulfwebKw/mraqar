...
instance.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest'; // instance.defaults.headers.common['X-CSRF-TOKEN'] = document.head.querySelector(
...
Vue.component('sign-up', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/auth/SignUp.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
Vue.component('add-to-wishlist', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/wishlist/AddToWishlist'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
Vue.component('like', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/likes/Like'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
Vue.component('comment', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/comments/comment'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
Vue.component('booking', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/advertising/Booking'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
Vue.component('create', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/advertising/Create'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
Vue.component('edit', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/advertising/Edit'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
Vue.component('wishlist-index', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/wishlist/WishlistIndex'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
Vue.component('show-user', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/user/ShowUser'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
Vue.component('profile', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/user/Profile'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
Vue.component('advertises', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/user/Advertises'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
Vue.component('search-section', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/site/SearchSection'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

Vue.use((vue_toast_notification__WEBPACK_IMPORTED_MODULE_0___default()));

Vue.use((vue_simple_uploader__WEBPACK_IMPORTED_MODULE_1___default()));
/**
