...
ezoom = {
    ...
    createZoomModalTag: function() {
		...
		var $ezoomWrap = $('<div id="zoomModal" class="modal" style="display:none;position:fixed;z-index: 1000000;padding:0px 0;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:rgba(0,0,0,0.8);transition:.3s"></div>'),
            $closeBtn = $('<span title="Close" class="fas fa-times material-icons-outlined material-icons mat-icon-lg" id="close" style="cursor:pointer;position:fixed;top:15px;right:30px;color:#b5b5b5;font-size:20px;font-weight:700;transition:.3s">cancel</span>'),
            $rotateRightBtn = $('<span title="Rotate right" class="fas fa-redo material-icons-outlined material-icons mat-icon-lg" id="close" style="z-index:1;cursor:pointer;position:fixed;top:15px;right:80px;color:#b5b5b5;font-size:20px;font-weight:700;transition:.3s">redo</span>'),
            $rotateLeftBtn = $('<span title="Rotate left" class="fas fa-undo material-icons-outlined material-icons mat-icon-lg" id="close" style="z-index:1;cursor:pointer;position:fixed;top:15px;right:130px;color:#b5b5b5;font-size:20px;font-weight:700;transition:.3s">undo</span>'),
