<card :purpose_lang="{rent: '{{ __('rent') }}' ,sell: '{{ __('sell') }}' ,exchange: '{{ __('exchange') }}' ,required_for_rent: '{{ __('required_for_rent') }}' , }" :card="card" v-for="card in cards" inline-template>
        ...
        <div :class="card.advertising_type === 'premium' ? 'bg-blue' : ''" class="border p-2">
            <div class="row">
                ...
                <div class="col-sm-10 w-sm4/5 p-0">
                    ...
                    <div :class="card.advertising_type === 'premium' ? 'fw-600' : ''" class="d-none d-sm-block d-md-block d-lg-more-block mb-2">
            ...
            <div class="row">
                <div :class="card.advertising_type === 'premium' ? 'fw-600' : ''" class="col-xs-12 p-0 d-sm-none d-md-none d-lg-more-none">
                    @{{card.description  | truncate(180, '...')}}
                </div>
            </div>
        </div>
