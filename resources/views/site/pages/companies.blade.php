                                    ...
                                    <div class="company-socials-container">
                                        @foreach($company->socials as $social)
                                            @if($social->type == 'instagram')
                                                ...
                                                <a href="{{ \Illuminate\Support\Str::contains($social->address, ['http://','https://']) ? $social->address : "https://www.instagram.com/".str_replace('@', '', $social->address)  }}" target="_blank">
                                            ...
                                            @elseif($social->type === 'twitter')
                                                <a href="{{ \Illuminate\Support\Str::contains($social->address, ['http://','https://']) ? $social->address : "https://twitter.com/".str_replace('@', '', $social->address)  }}" target="_blank">
                                                    <svg class="material-icons mat-icon-md company-social" viewBox="0 0 24 24">
                                            ...
                                            @elseif($social->type === 'email')
                                                <a href="mailto:{{$social->address}}" target="_blank">
                                                    <svg class="material-icons mat-icon-md company-social" viewBox="0 0 24 24">
                                                        <path fill="currentColor" d="M20,8L12,13L4,8V6L12,11L20,6M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z" />
                                                    </svg>
                                                </a>
                                            @elseif($social->type === 'facebook')
                                                <a href="{{ \Illuminate\Support\Str::contains($social->address, ['http://','https://']) ? $social->address : "https://www.facebook.com/".str_replace('@', '', $social->address)  }}" target="_blank">
                                                    <svg class="material-icons mat-icon-md company-social" viewBox="0 0 24 24">
