                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-xs-7 col-md-12 center-xs p-0">
                                ...
                                @php
                                    ...
                                    $tel = str_replace(' ', '', $tel);
                                @endphp
                                <a href="{{ route('companies.show',[ 'locale' => app()->getLocale() , 'phone' => $tel ,  'name' => \Illuminate\Support\Str::slug($company->company_name) ])  }}" class="my-1 fw-600 text-body links company-name">{{ $company->company_name }}</a>
