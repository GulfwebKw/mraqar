...
{{--            @dd($company->company_name)--}}
            ...
            <div class="section mt-0 py-5" style="background: var(--mdc-theme-primary)">
                <div class="">
                    <div class="theme-container company-container">
                        <div class="row" style="flex-wrap: wrap; align-items: center;">
                            <img src="{{ asset($company->image_profile) }}" class="col-xs-6 col-lg-4 col-xl-4 p-0 mw-100 d-block rounded mx-auto">
                            <div class="col-xs-12 col-lg-8 col-xl-8 p-3 center-xs text-white">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @foreach($company->socials as $social)
                                                @if($social->type == 'instagram')
                                                    <a class="decoration-none" href="{{ \Illuminate\Support\Str::contains($social->address, ['http://','https://']) ? $social->address : "https://www.instagram.com/".str_replace('@', '', $social->address)  }}" target="_blank">
                                                ...
                                                @elseif($social->type === 'twitter')
                                                    <a class="decoration-none" href="{{ \Illuminate\Support\Str::contains($social->address, ['http://','https://']) ? $social->address : "https://twitter.com/".str_replace('@', '', $social->address)  }}" target="_blank">
                                                        <svg class="material-icons mat-icon-md company-social text-white" viewBox="0 0 24 24">
                                                ...
                                                @elseif($social->type === 'facebook')
                                                    <a class="decoration-none" href="{{ \Illuminate\Support\Str::contains($social->address, ['http://','https://']) ? $social->address : "https://www.facebook.com/".str_replace('@', '', $social->address)  }}" target="_blank">
                                                        <svg class="material-icons mat-icon-md company-social text-white" viewBox="0 0 24 24">
