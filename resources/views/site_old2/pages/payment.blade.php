    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">
                    Price : {{optional($payment)->price}} {{__('kd_title')}}
                </p>
                <p class="card-text">
                ...
                <p class="card-text">
                    Trans ID  : {{optional($order)->tranid}}
                </p>
                <p class="card-text">
        ...
        <div class="row justify-content-center">
            <a href="{{ route('Main.paymentHistory', app()->getLocale()) }}">
                <button type="button" class="btn btn-primary">Back To Ajrni</button>
            </a>
        </div>
</div>
