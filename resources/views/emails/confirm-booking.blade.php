...
<head>
    ...
    <title>@if(isset($title)) {{$title}} @else Confirm Advertising @endif</title>
</head>
                ...
                <tr style="background: #ffffff;">
                    <td align="center" valign="top" style="font-size:0; padding: 10px; " >
                        <div style="display:inline-block; max-width:100%; min-width:100px;  width:100%;">
                            <img src="http://ajrnii.com/images/logo.png" width="60" height="60" style="display: block; border: 0px;" />
                        </div>
                                ...
                                <td align="left" style="padding-top: 20px;">
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            ...
                                            <td width="25%" align="left" bgcolor="#eeeeee" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;"> {{optional($booking->advertising->user)->name}} </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="25%" align="left" bgcolor="#eeeeee" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;"> {{$booking->advertising->title_en}}/ {{$booking->advertising->title_ar}} </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="25%" align="left" bgcolor="#eeeeee" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;">  {{$booking->advertising->price}} </td>
                                        </tr>
